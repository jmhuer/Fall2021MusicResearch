...
<audio controls>
  <source src="../../../human_feedback/group3/NGroup3_0.5_1.wav" type="audio/wav">
Your browser does not support the audio element.
</audio><br>
<br>
...
<br>
  ...
  <label for="41"> A </label><br>
  <input type="checkbox" id="42" name="42" value="42">
  <label for="42"> B </label><br>
<br>
...
<br>
  ...
  <label for="45"> A </label><br>
  <input type="checkbox" id="46" name="46" value="46">
  <label for="46"> B </label><br>
<br>
...
<br>
  ...
  <label for="47"> A </label><br>
  <input type="checkbox" id="48" name="48" value="48">
  <label for="48"> B </label><br>
<br>
...
<audio controls>
  <source src="../../../human_feedback/group2/GGroup3_0.5_1.wav" type="audio/wav">
Your browser does not support the audio element.
</audio><br>
<br>
...
<audio controls>
  <source src="../../../human_feedback/group2/GGroup3_1.5_1.wav" type="audio/wav">
Your browser does not support the audio element.
</audio><br>
<br>
  <input type="checkbox" id="49" name="49" value="49">
  <label for="49"> A </label><br>
  <input type="checkbox" id="50" name="50" value="50">
  <label for="50"> B </label><br>
<br>
...
<audio controls>
  <source src="../../../human_feedback/group2/JGroup2_1.0_1.wav" type="audio/wav">
Your browser does not support the audio element.
</audio><br>
<br>
...
<audio controls>
  <source src="../../../human_feedback/group2/JGroup2_1.9_1.wav" type="audio/wav">
Your browser does not support the audio element.
</audio><br>
<br>
